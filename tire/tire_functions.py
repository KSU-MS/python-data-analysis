...
from tire_model_pacejka_2010 import tire_model_from_arr
...
class Car:
    def __init__(self, mass = 663 * LB_TO_KG, front_axle_weight = 0.49) -> None:
        ...
        self.debug = False
        self.mass = mass # mass of vehicle [kg]
        self.wb = 60.25 * IN_TO_M #Wheelbase [m]
        self.front_axle_weight = front_axle_weight # weight distribution toward front axle (#)
        self.mass_unsprung = 74 * LB_TO_KG # mass of outboard [kg]
        self.front_track = 48 * IN_TO_M # front track width [m]
        self.rear_track = 47 * IN_TO_M # rear track width [m]
        self.cg_height = 11.7 * IN_TO_M # CG height above ground [m]
        self.A = 1.0 # aero area [m^2]
        ...
        self.izz = 78.5 # moment of inertia of vehicle [kg*m^2] 78.5
        # Front and Rear toe angles are per side, negative is toe out confirmed
        self.toe_front = -0.5 # [deg]
        self.toe_rear = -0.5 # [deg]
        # Camber is in adapted ISO so a positive number is negative camber
        self.i_a_f = -1.25 # [deg]
        self.i_a_r = -1.25 # [deg]
        self.k_c = 1456 * FTLB_TO_NM #Chassis stiffness in N-m/deg
        ...
        self.power = 52000 # in watts 61000
        self.max_torque = 165 # in N x m at the motor
        ...
        self.front_master_cylinder_dia = 19.1 # mm
        self.rear_master_cylinder_dia = 23.8 # mm
        self.front_piston_dia = 31.75 # mm
        self.rear_piston_dia = 31.75 # mm
        self.front_rotor_er = 5.84 * IN_TO_M * 0.5 # m effective radius
        self.rear_rotor_er = 5.84 * IN_TO_M * 0.5 # m
...
if __name__ == '__main__':
    ...
    start = time.time()
    ay_it1, yaw_it1, cn1, ax_it1, delta, beta, kappa, valid, LAS_points = car.mm()
